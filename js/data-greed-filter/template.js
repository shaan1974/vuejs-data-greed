        ...
        <form>
            ...
            <template v-for="(d,form_index) in filter.sidebarForm.form">
                ...
                <template v-if="d.type==='input-text'">
                    ...
                    <div class="form-group" v-if="typeof d.value !== 'undefined' ">
                        
                        <div class="w-100">
                            <label>[A1]{{config.labels.columns[d.column_ref]}}</label>
                        </div>
                    ...
                    <div class="form-group" v-if="typeof d.values !== 'undefined' ">
                        
                        <div class="w-100 pb-2">
                            <label>[A2]-{{config.labels.columns[d.column_ref]}}</label> 
                ...
                <template v-if="d.type==='dd-input-text'">
                    ...
                    <div class="form-row" v-if="typeof d.value !== 'undefined' ">

                        <div class="form-group col-md-4">
                        <label>[B1]-{{config.labels.columns[d.column_ref]}}</label>
                    ...
                    <div class="form-row" v-if="typeof d.values !== 'undefined' ">
                        
                        <div class="col-12 pb-2">
                            <label>[B2]-{{config.labels.columns[d.column_ref]}}</label>                            
                        ...
                        <template v-for="(e,inside_index) in d.values">
                            ...
                            <div class="col-2">
                                <button type="button" class="btn btn-sm btn-danger float-right" v-if="d.values.length>1" v-on:click="d.values.splice(inside_index, 1);d.op.splice(inside_index, 1)">-</button>
                            </div>                        
                ...
                <template v-if="d.type==='dd-input-number'">
                    ...
                    <div class="form-row" v-if="typeof d.value1 !== 'undefined' ">
                    ...
                    <div class="form-row" v-if="typeof d.values1 !== 'undefined' ">
                        
                        <div class="col-12 pb-2">
                            <label>[C2]-{{config.labels.columns[d.column_ref]}}</label>                            
                ...
                <template v-if="d.type==='dictionnary'">
                    ...
                    <div class="form-group" v-if="typeof d.value !== 'undefined' ">
                        ...
                        <label>[D1]-{{config.labels.columns[d.column_ref]}}</label>
                    ...
                    <div class="form-row" v-if="typeof d.values !== 'undefined' ">
                        ...
                        <div class="col-12 pb-2"><label>[D2]-{{config.labels.columns[d.column_ref]}}</label></div>
            ...
            <button type="button" class="btn btn-secondary btn-sm float-left" v-on:click="this.resetFilter(this.filter.sidebarForm.form)" v-html="filter.labels.btn_reset"></button>
